...
double G_K21(double f(double),double a,double b,double *abserr,
	double *resabs, double *resasc);
double G_K31(double f(double),double a,double b,double *abserr,
	double *resabs, double *resasc);
double G_K41(double f(double),double a,double b,double *abserr,
	double *resabs, double *resasc);
double G_K51(double f(double),double a,double b,double *abserr,
	double *resabs, double *resasc);
double G_K61(double f(double),double a,double b,double *abserr,
	double *resabs, double *resasc);
...
double G_K15W(double f(double),double w(double),double p1,double p2,double p3,
...
double dqng(double f(double),double a,double b,double epsabs,double epsrel,
	double *abserr,int *neval,int *ier);
double dqag(double f(double),double a,double b,double epsabs,double epsrel,
	int irule,double *abserr,int *neval,int *ier);
double dqage(double f(double),double a,double b,double epsabs,double epsrel,
...
double dqc25o(double f(double),double a,double b,double omega,int integr,
	int nrmom,int maxp1,int ksave,double *abserr,int *neval,
	double *resabs,double *resasc,int *momcom,double **chebmo);		
double dqfour(double f(double),double a,double b,double omega,int integr,
    double epsabs,double epsrel,int icall,int maxp1,
    double *abserr,int *neval,int *ier,int *momcom,
	double **chebmo);
double dqawfe(double f(double),double a,double omega,int integr,double epsabs,
    int limlst,int maxp1,double *abserr,int *neval,int *ier,
    double *rslst,double *erlist,int *ierlst,double **chebmo);
double dqawf(double f(double),double a,double omega,int integr,double epsabs,
	double *abserr,int *neval,int *ier);
double dqawo(double f(double),double a,double b,double omega,int integr,double epsabs,
	double epsrel,double *abserr,int *neval,int *ier);
double dqaws(double f(double),double a,double b,double alfa,double beta,int wgtfunc,
    double epsabs,double epsrel,double *abserr,int *neval,int *ier);
...
double dqc25s(double f(double),double a,double b,double bl,double br,double alfa,
...
double dqc25c(double f(double),double a,double b,double c,double *abserr,
    int *krul,int *neval);
double dqawc(double f(double),double a,double b,double c,double epsabs,
    double epsrel,double *abserr,int *neval,int *ier);
double dqawce(double f(double),double a,double b,double c,double epsabs,
    double epsrel,double *abserr,int *neval,int *ier);

double G_B15(double f(double),double a,double b,double *abserr,
	double *resabs, double *resasc);
